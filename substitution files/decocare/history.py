...
from . import lib # Changed from "import lib"
from .records import * # Changed from "from record import *"
...
class ChangeBasalProfile_old_profile (KnownRecord):
  ...
  def decode (self):
    ...
    for x in range(47):
      ...
      except TypeError as e: # Changed from "except TypeError, e:"
...
def parse_midnight (data):
    ...
    try:
      ...
      return date
    except ValueError as e: # Changed from "except ValueError, e:"
      print("ERROR", e, lib.hexdump(data)) # Parenthesis added
      pass
    return mid
